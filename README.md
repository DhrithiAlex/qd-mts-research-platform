...
[![Project Screenshot](https://github.com/DhrithiAlex/qd-mts-research-platform/raw/main/Media/Github_Preview.png)](Media/Github_Preview.png)
...
- - **Oncology — Solid Tumor Imaging** — a five-zone tumor microenvironment model, tumor grading, and passive (EPR) vs. active (receptor-targeted) delivery strategies for fluorescence-guided tumor imaging.
  ...
  - **Two more are planned:** Alzheimer's disease (reusing the hippocampal 3D geometry) and diabetes (a structurally different, biosensor-based module). See Roadmap below.
  - 
